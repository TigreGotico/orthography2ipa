"""Germanic ancestral chain — Proto-Northwest-Germanic through Old stages.
...
from orthography2ipa.languages.germanic_historical import (
    GRAPHEMES_GEM, ALLOPHONES_GEM,
)
