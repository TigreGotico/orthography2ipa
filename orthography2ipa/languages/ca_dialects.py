...
Sources:
- Wheeler, M.W. (2005). *The Phonology of Catalan*. OUP.
- Carbonell & Llisterri (1992). Catalan. *JIPA*.
- Veny, J. (1982). *Els parlars catalans*. Moll.
- Bec, P. (1968). *Les interférences linguistiques entre gascon et languedocien*.
- Carrera, A. (2007). *Gramatica aranesa*. Pagès.
...
"""
from orthography2ipa.languages.ca import GRAPHEMES, ALLOPHONES
