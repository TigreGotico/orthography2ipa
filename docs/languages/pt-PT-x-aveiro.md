# Beira-Litoral (Aveiro) European Portuguese (`pt-PT-x-aveiro`) — Phonology Reference

**Code**: `pt-PT-x-aveiro` | **Family**: Indo-European > Romance > Ibero-Romance | **Script**: Latin (alphabet)
...
**Aveiro, Vagos — Beira Litoral coast**. In Cintra's Baixo-Minhoto-Duriense-Beirão group; Pérez (2014, pp.35-37) shows the bilabial /b/–/v/ merger extending along the coast **north of Coimbra**, i.e. the Aveiro littoral. A local retroflex-lateral [ɭ] realisation of /l/ is reported in regional-dialect literature (not in Cintra/Pérez) and is enumerated as a secondary allophonic variant only.
