...
class TestRussian:
    ...
    def test_family(self):
        ...
        assert {"Indo-European", "Slavic", "East Slavic"} <= set(self._spec.family_path), f"Expected family='Indo-European > Slavic > East Slavic', got {self._spec.family!r}"
...
class TestPolish:
    ...
    def test_family(self):
        ...
        assert {"Indo-European", "Slavic", "West Slavic"} <= set(self._spec.family_path), f"Expected family='Indo-European > Slavic > West Slavic', got {self._spec.family!r}"
...
class TestBulgarian:
    ...
    def test_family(self):
        ...
        assert {"Indo-European", "Slavic", "South Slavic"} <= set(self._spec.family_path), f"Expected family='Indo-European > Slavic > South Slavic', got {self._spec.family!r}"
...
class TestSlovak:
    ...
    def test_family_slavic(self):
        ...
        assert {"Indo-European", "Slavic", "West Slavic"} <= set(self._spec.family_path)
...
class TestUkrainian:
    ...
    def test_family_slavic(self):
        ...
        assert {"Indo-European", "Slavic", "East Slavic"} <= set(self._spec.family_path)
