...
- docs\(lattice\_per\): state the measured values of the eu examples [\#1560](https://github.com/TigreGotico/orthography2ipa/pull/1560) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- data\(gwc\): measured tone valid\_ceiling for wikipron \(0.2626\) [\#1557](https://github.com/TigreGotico/orthography2ipa/pull/1557) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix\(ar-SA-x-qassim\): carry the condition on veh's second reading [\#1578](https://github.com/TigreGotico/orthography2ipa/pull/1578) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(ar-x-gulf\): read waw and ya after a consonant as long vowels first [\#1551](https://github.com/TigreGotico/orthography2ipa/pull/1551) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix\(ar-SA-x-qassim\): the loan graphemes read as Qassimi adaptations [\#1575](https://github.com/TigreGotico/orthography2ipa/pull/1575) ([JarbasAl](https://github.com/JarbasAl))
...
- ci: gate the ru and en-US/cmudict rows in the board jobs [\#1523](https://github.com/TigreGotico/orthography2ipa/pull/1523) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(ar-SA-x-hejaz\): read waw and ya after a consonant as long vowels first [\#1554](https://github.com/TigreGotico/orthography2ipa/pull/1554) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix\(ar-SY\): read waw and ya after a consonant as long vowels first [\#1550](https://github.com/TigreGotico/orthography2ipa/pull/1550) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
- docs: cite the descriptions behind seven research-tier specs [\#1520](https://github.com/TigreGotico/orthography2ipa/pull/1520) ([JarbasAl](https://github.com/JarbasAl))
...
- test: remove inherited pytest and resource warnings [\#1559](https://github.com/TigreGotico/orthography2ipa/pull/1559) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- docs: cite the descriptions behind two research-tier specs [\#1519](https://github.com/TigreGotico/orthography2ipa/pull/1519) ([JarbasAl](https://github.com/JarbasAl))
...
- docs: cite the descriptions behind eight research-tier specs [\#1516](https://github.com/TigreGotico/orthography2ipa/pull/1516) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: the Arabic key generator stops deleting the allophone rules it does not own [\#1562](https://github.com/TigreGotico/orthography2ipa/pull/1562) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix: Barranquenho is its own language, modelled like a creole [\#1545](https://github.com/TigreGotico/orthography2ipa/pull/1545) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix: let the gold cache be refreshed, and say when upstream moved [\#1528](https://github.com/TigreGotico/orthography2ipa/pull/1528) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: reach the intended lect for consumer spellings of private-use tags [\#1525](https://github.com/TigreGotico/orthography2ipa/pull/1525) ([JarbasAl](https://github.com/JarbasAl))
...
- docs: let the Lexibank tables defer to the scoreboard [\#1524](https://github.com/TigreGotico/orthography2ipa/pull/1524) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: scope --ci-sample to --lang and --dataset like --scoreboard [\#1522](https://github.com/TigreGotico/orthography2ipa/pull/1522) ([JarbasAl](https://github.com/JarbasAl))
...
- docs: cite the descriptions behind fifteen more research-tier specs [\#1521](https://github.com/TigreGotico/orthography2ipa/pull/1521) ([JarbasAl](https://github.com/JarbasAl))
...
- chore: rescore the eight rows whose gold moved [\#1531](https://github.com/TigreGotico/orthography2ipa/pull/1531) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: Barranquenho is a Portuguese lect, not an Extremaduran one [\#1511](https://github.com/TigreGotico/orthography2ipa/pull/1511) ([JarbasAl](https://github.com/JarbasAl))
- feat: accept a prebuilt spec and export syllabify\_ipa [\#1507](https://github.com/TigreGotico/orthography2ipa/pull/1507) ([JarbasAl](https://github.com/JarbasAl))
...
- docs\(mwl\): settle the unstressed-vowel question from the published description [\#1499](https://github.com/TigreGotico/orthography2ipa/pull/1499) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: derive the moved board rows from the diff [\#1508](https://github.com/TigreGotico/orthography2ipa/pull/1508) ([JarbasAl](https://github.com/JarbasAl))
...
- docs: how to find and verify a citable source [\#1506](https://github.com/TigreGotico/orthography2ipa/pull/1506) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(gd\): pronounce the verbal-noun ending -adh as \[əɣ\] [\#1496](https://github.com/TigreGotico/orthography2ipa/pull/1496) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(mic\): read the apostrophe as vowel length and g as /k/ [\#1495](https://github.com/TigreGotico/orthography2ipa/pull/1495) ([JarbasAl](https://github.com/JarbasAl))
...
- car: vowel length from a weight-alternating footing rule \(wold row rises, documented\) [\#1488](https://github.com/TigreGotico/orthography2ipa/pull/1488) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(kas\): map Kashmiri yeh ؠ to palatalisation ʲ, not a glide [\#1486](https://github.com/TigreGotico/orthography2ipa/pull/1486) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: correct yux soft sign palatalisation \(ь, дь, ль\) [\#1484](https://github.com/TigreGotico/orthography2ipa/pull/1484) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(yrk\): compose Cyrillic soft sign as palatalisation, not deletion [\#1480](https://github.com/TigreGotico/orthography2ipa/pull/1480) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(kas\): read أ as the short vowel ə, not alef plus the hamza vowel [\#1476](https://github.com/TigreGotico/orthography2ipa/pull/1476) ([JarbasAl](https://github.com/JarbasAl))
...
- docs\(km\): record the ipadict/wikipron notation split, and what it does not explain [\#1474](https://github.com/TigreGotico/orthography2ipa/pull/1474) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(stq\): align stq.json with Peters \(2019\), not an over-generalised German transfer [\#1472](https://github.com/TigreGotico/orthography2ipa/pull/1472) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: map every apostrophe-family codepoint a spec's gold actually uses [\#1470](https://github.com/TigreGotico/orthography2ipa/pull/1470) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: ket apostrophe codepoint mismatch drops laryngealized ʔ [\#1468](https://github.com/TigreGotico/orthography2ipa/pull/1468) ([JarbasAl](https://github.com/JarbasAl))
...
- feat\(fa\): add fa-x-enp spec for the ENP reading fas\_arab\_broad.tsv transcribes [\#1462](https://github.com/TigreGotico/orthography2ipa/pull/1462) ([JarbasAl](https://github.com/JarbasAl))
...
[Full Changelog](https://github.com/TigreGotico/orthography2ipa/compare/7.24.0a2...7.24.0a1)

## [7.24.0a2](https://github.com/TigreGotico/orthography2ipa/tree/7.24.0a2) (2026-07-16)

[Full Changelog](https://github.com/TigreGotico/orthography2ipa/compare/7.23.0a3...7.24.0a2)
...
[Full Changelog](https://github.com/TigreGotico/orthography2ipa/compare/7.12.0a1...7.14.0a1)
