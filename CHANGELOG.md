...
- feat\(benchmark\): restore Wiktionary display headwords onto lossy WikiPron golds [\#1433](https://github.com/TigreGotico/orthography2ipa/pull/1433) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: map dropped Polabian graphemes in pox spec [\#1441](https://github.com/TigreGotico/orthography2ipa/pull/1441) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(phl\): add nine graphemes the resolved spec silently dropped [\#1439](https://github.com/TigreGotico/orthography2ipa/pull/1439) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(benchmark\): stop scoring the reconstruction asterisk as a phoneme [\#1437](https://github.com/TigreGotico/orthography2ipa/pull/1437) ([JarbasAl](https://github.com/JarbasAl))
...
- Model Rheinische Dokumenta as li-x-rheindok [\#1434](https://github.com/TigreGotico/orthography2ipa/pull/1434) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(audit\): backfill audit records for Arabic/Hebrew undiacritized-input rows [\#1430](https://github.com/TigreGotico/orthography2ipa/pull/1430) ([JarbasAl](https://github.com/JarbasAl))
- fix: catch a committed board row diverging from real spec behavior [\#1428](https://github.com/TigreGotico/orthography2ipa/pull/1428) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(lmo\): split classical Milanese circumflex orthography into its own entry [\#1425](https://github.com/TigreGotico/orthography2ipa/pull/1425) ([JarbasAl](https://github.com/JarbasAl))
...
- audit\(da\): wikipron ceiling measurement — rhotic/s-cluster notation dominates, not stod [\#1423](https://github.com/TigreGotico/orthography2ipa/pull/1423) ([JarbasAl](https://github.com/JarbasAl))
...
- feat\(gmh\): add gmh-x-wikt spec for Wiktionary title-form MHG orthography [\#1424](https://github.com/TigreGotico/orthography2ipa/pull/1424) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(ja\): record ipadict as a logographic audit, not a rule defect [\#1421](https://github.com/TigreGotico/orthography2ipa/pull/1421) ([JarbasAl](https://github.com/JarbasAl))
...
- data: backfill machine-readable audit records for 14 rows \(\#1369\) [\#1419](https://github.com/TigreGotico/orthography2ipa/pull/1419) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(enm\): add missing y/x/ð grapheme coverage, re-measure ceiling [\#1417](https://github.com/TigreGotico/orthography2ipa/pull/1417) ([JarbasAl](https://github.com/JarbasAl))
- fix\(bbl\): map ჼ nasalization letter, fold gold's IPA-modifier laterals/pharyngeals [\#1415](https://github.com/TigreGotico/orthography2ipa/pull/1415) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(pdc\): implement word-final obstruent devoicing [\#1410](https://github.com/TigreGotico/orthography2ipa/pull/1410) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: correct mismatched DOIs cited in specs \(\#1407\) [\#1408](https://github.com/TigreGotico/orthography2ipa/pull/1408) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(ykg\): correct plain/palatalised lateral direction, mislabelled citation [\#1405](https://github.com/TigreGotico/orthography2ipa/pull/1405) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(yol\): implement the three defects the spec notes wrongly called unimplementable [\#1402](https://github.com/TigreGotico/orthography2ipa/pull/1402) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: backfill valid\_ceiling onto board rows missing it [\#1398](https://github.com/TigreGotico/orthography2ipa/pull/1398) ([JarbasAl](https://github.com/JarbasAl))
...
- docs\(se\): record Northern Sami audit measurements in spec notes [\#1393](https://github.com/TigreGotico/orthography2ipa/pull/1393) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(ml\): rhotic tap/trill split, റ്റ-gemination stop, and samvrutokaram [\#1390](https://github.com/TigreGotico/orthography2ipa/pull/1390) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(ny\): measure and document the tone valid\_ceiling [\#1389](https://github.com/TigreGotico/orthography2ipa/pull/1389) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(gmh\): schwa-reduce unstressed e, apical s, geminate z digraphs [\#1387](https://github.com/TigreGotico/orthography2ipa/pull/1387) ([JarbasAl](https://github.com/JarbasAl))
- docs\(data\): record enm/wikipron gold length-notation ceiling and negative results [\#1386](https://github.com/TigreGotico/orthography2ipa/pull/1386) ([JarbasAl](https://github.com/JarbasAl))
...
- docs\(br\): record mutation and stress ceiling measurement as negative result [\#1384](https://github.com/TigreGotico/orthography2ipa/pull/1384) ([JarbasAl](https://github.com/JarbasAl))
- fix\(sa\): ground short/long a and र in Whitney \(1889\), not schwa/trill [\#1382](https://github.com/TigreGotico/orthography2ipa/pull/1382) ([JarbasAl](https://github.com/JarbasAl))
...
- feat\(data\): measure and document Croatian \(hr\) accent/length ceiling [\#1381](https://github.com/TigreGotico/orthography2ipa/pull/1381) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(bn\): word-final inherent-vowel deletion [\#1375](https://github.com/TigreGotico/orthography2ipa/pull/1375) ([JarbasAl](https://github.com/JarbasAl))
...
- feat\(data\): sl valid\_ceiling for wikipron -- pitch-accent/stress is input-limited [\#1374](https://github.com/TigreGotico/orthography2ipa/pull/1374) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(kk\): correct Kazakh а/ɑ and ы/ə against a peer-reviewed source [\#1370](https://github.com/TigreGotico/orthography2ipa/pull/1370) ([JarbasAl](https://github.com/JarbasAl))
...
- docs\(gd\): fetch real citation, replace Wikipedia sources, measure svarabhakti/preaspiration folds [\#1372](https://github.com/TigreGotico/orthography2ipa/pull/1372) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(nb\): short ⟨a⟩ is back \[ɑ\], not front \[a\] [\#1366](https://github.com/TigreGotico/orthography2ipa/pull/1366) ([JarbasAl](https://github.com/JarbasAl))
...
- fix\(xh\): record kaikki tone-fold valid\_ceiling measurement [\#1364](https://github.com/TigreGotico/orthography2ipa/pull/1364) ([JarbasAl](https://github.com/JarbasAl))
- feat: backfill measured valid\_ceiling for th and tn [\#1363](https://github.com/TigreGotico/orthography2ipa/pull/1363) ([JarbasAl](https://github.com/JarbasAl))
- fix\(am\): correct the ejective velar and pharyngeal-glottal mergers [\#1359](https://github.com/TigreGotico/orthography2ipa/pull/1359) ([JarbasAl](https://github.com/JarbasAl))
...
- docs\(nb\): record ipadict/wikipron length- and toneme-fold PER measurements [\#1361](https://github.com/TigreGotico/orthography2ipa/pull/1361) ([JarbasAl](https://github.com/JarbasAl))
